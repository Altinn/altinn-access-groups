...
{
    /// <summary>
    /// Interface for postgreSQL operations on accessgroups.
    /// </summary>
    public interface IAccessGroupsRepository
    {
        ...
        /// </summary>
        /// <param name="membership">The membership model to insert.</param>
        /// <returns>The list of access groups.</returns>
        ...
        /// </summary>
        /// <param name="search">Model containing searchparameters.</param>
        /// <returns>The list of access groups.</returns>
        ...
        /// </summary>
        /// <param name="input">Membership model of membership to revoke.</param>
        /// <returns>A bool to determine if revoke is successfull.</returns>
