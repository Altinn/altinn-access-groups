...
{
    public class AccessGroupUnitTests : IClassFixture<CustomWebApplicationFactory<AccessGroupController>>
    {
        private readonly CustomWebApplicationFactory<AccessGroupController> _factory;

        public AccessGroupUnitTests(CustomWebApplicationFactory<AccessGroupController> factory)
        {
            _factory = factory;
        }
